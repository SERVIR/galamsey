    ...
    4. Enter tethys test command.
       ...
       See below for specific examples
        ...
        To run all tests across this app:
            Test command: "tethys test -f tethys_apps.tethysapp.galamsey"

        To run all tests in this file:
            Test command: "tethys test -f tethys_apps.tethysapp.galamsey.tests.tests"

        To run tests in the GalamseyTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.galamsey.tests.tests.GalamseyTestCase"

        To run only the test_if_tethys_platform_is_great function in the GalamseyTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.galamsey.tests.tests.GalamseyTestCase.test_if_tethys_platform_is_great"
...
class GalamseyTestCase(TethysTestCase):
    """
    ...
    def set_up(self):
        ...
        test database creation function here, like so:
            ...
            self.create_test_persistent_stores_for_app(Galamsey)
    ...
    def tear_down(self):
        ...
        stores, you should call the test database destruction function from here, like so:
            ...
            self.destroy_test_persistent_stores_for_app(Galamsey)
    ...
    def test_home_controller(self):
        ...
        response = c.get('/apps/galamsey/')  # The final '/' is essential for all pages/controllers
